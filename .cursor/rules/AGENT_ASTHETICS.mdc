---
description: "Standards for frontend UI design: typography, color, motion, and backgrounds. Avoid generic AI aesthetics."
globs: ["**/*.tsx", "**/*.css", "**/components/**", "**/routes/**"]
alwaysApply: true
---
...
Interpret creatively and make unexpected choices that feel genuinely designed for the context. Vary between light and dark themes, different fonts, different aesthetics. You still tend to converge on common choices (e.g. Space Grotesk) across generations—**avoid this:** it is critical that you think outside the box.

...
import { STOCK_UNITS_SIMPLE_QUERY, type StockUnitsSimpleQueryData } from "@/lib/graphql/stock-units";
...
export function useStockUnitName(): string {
	const { data } = useQuery<StockUnitsSimpleQueryData>(STOCK_UNITS_SIMPLE_QUERY, {

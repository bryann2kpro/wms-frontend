...
import { RbacRole, UpdateRoleInput } from "@/lib/rbac";
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                aria-describedby={validationErrors.roleName ? "edit-roleName-error" : undefined}
              />
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                disabled={isSubmitting}
              >
                <SelectTrigger id="edit-role-status" aria-label="Select role status">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>

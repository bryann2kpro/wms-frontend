              ...
              <FieldGroup>
                ...
                <form.Field
                  ...
                  children={(field) => {
                    ...
                    return (
                      <Field data-invalid={isInvalid}>
                        <FieldLabel htmlFor={field.name}>Received Date</FieldLabel>
                        <Input
                          id={field.name}
                          type="date"
                          value={field.state.value}
        ...
        <CardHeader>
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <CardDescription>View and manage all goods receipt notes</CardDescription>
            </div>
              ...
              <div className="space-y-6">
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <p className="text-sm font-medium">{selectedGRN.grnNumber}</p>
                  </div>
                  <div>
                    <Label className="text-xs text-muted-foreground">
                      Transfer Order
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium">{selectedGRN.supplier}</p>
                  </div>
                  <div>
                    <Label className="text-xs text-muted-foreground">
                      Received Date
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium">{selectedGRN.createdBy}</p>
                  </div>
                </div>

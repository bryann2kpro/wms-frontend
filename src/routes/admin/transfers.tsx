...
function TransfersRouteComponent() {
  ...
  const [selectedTransfer, setSelectedTransfer] = useState<TransferDetail | null>(
    null,
  )
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage warehouse-to-warehouse transfers and track shipments
          </p>
        </div>
        <Dialog
          open={isCreateOpen}
        ...
        <CardHeader>
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <CardDescription>View and manage all transfer orders</CardDescription>
            </div>
          ...
          {data && (
            <div className="mt-4 flex items-center justify-between text-xs text-muted-foreground">
              <div>
                ...
                of <span className="font-medium">{data.total}</span> transfer orders
              </div>
              <div className="flex items-center gap-2">
                <Button
                  variant="outline"
            ...
            <ScrollArea className="max-h-[calc(90vh-8rem)] pr-4">
              <div className="space-y-6">
                <div className="grid gap-4 sm:grid-cols-3">
                  <div>
                    <Label className="text-xs text-muted-foreground">TO Number</Label>
                ...
                <DialogFooter>
                  ...
                  {selectedTransfer.status === 'pending' && (
                    <Button
                      onClick={() => {
                        handleUpdateStatus(selectedTransfer.id, 'in_transit')
                      }}
                  ...
                  {selectedTransfer.status === 'in_transit' && (
                    <Button
                      onClick={() => {
                        handleUpdateStatus(selectedTransfer.id, 'completed')
                      }}
                      disabled={statusMutation.status === 'pending'}
                    >
